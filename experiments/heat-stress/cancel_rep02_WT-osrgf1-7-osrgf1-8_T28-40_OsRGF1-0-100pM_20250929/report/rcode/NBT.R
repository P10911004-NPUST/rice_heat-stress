...
df0 <- rawdata %>% 
    ...
    dplyr::mutate(
        ...
        heat = factor(paste0("T", heat), levels = c("T28", "T40")),
        RGF1 = dplyr::case_when(RGF1 == 0 ~ 0,
                                RGF1 == 100 ~ 1,
                                TRUE ~ RGF1),
...
df0$group <- factor(
    df0$group, 
    levels = c("WT_T28_0", "osrgf1-7_T28_0", "WT_T40_0", "osrgf1-7_T40_0",
               "WT_T28_1", "osrgf1-7_T28_1", "WT_T40_1", "osrgf1-7_T40_1")
)
